...
export default function ContactForm() {
  ...
  const validateForm = (): boolean => {
    ...
    } else if (!/^(\+30|0030|30)?[0-9]{10}$/.test(formData.phone.replace(/\s/g, ''))) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setSubmitMessage('Το μήνυμά σας στάλθηκε επιτυχώς! Θα επικοινωνήσουμε μαζί σας σύντομα.');
        setFormData({
          name: '',
          phone: '',
          email: '',
      ...
      setSubmitMessage('Συγγνώμη, υπήρξε πρόβλημα με την αποστολή. Παρακαλώ δοκιμάστε ξανά ή τηλεφωνήστε μας.');
    } finally {
  ...
  return (
    <div className="bg-white rounded-xl shadow-lg p-8 max-w-2xl mx-auto">
      <div className="text-center mb-8">
        <h2 className="text-3xl font-bold text-gray-900 mb-2">Επικοινωνήστε μαζί μας</h2>
        <p className="text-gray-600">Στείλτε μας το μήνυμά σας και θα επικοινωνήσουμε μαζί σας άμεσα</p>
      </div>
