...
export default function SEO({
  ...
  const fullTitle = title.includes('RentRibAthens')
    ? title
    : `${title} | RentRibAthens`;
  const siteUrl =
    process.env.NEXT_PUBLIC_SITE_URL || 'https://rentribathens.gr';
  const fullCanonical = canonical ? `${siteUrl}${canonical}` : siteUrl;
  const fullOgImage = openGraphImage.startsWith('http')
    ? openGraphImage
  ...
  return (
    <Head>
      ...
      <meta
        name='keywords'
        content='RIB, ενοικίαση, Αθήνα, Σαρωνικός, περιηγήσεις, σκάφη, θαλάσσια εκδρομές, Λαγονήσι, boat rental, Athens, Greece'
      />
      ...
      <meta
        ...
        content='Ενοικίαση RIB σκαφών στην Αθήνα'
      />
