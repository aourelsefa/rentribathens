      ...
      <div className="relative h-64 overflow-hidden">
        ...
        <div className="absolute top-4 right-4">
          <div className="bg-green-500 px-4 py-2 rounded-full shadow-lg">
            <span className="text-white text-sm font-semibold">€{boat.pricePerDay}/ημέρα</span>
          </div>
        </div>
        ...
        <div className="absolute bottom-0 left-0 right-0 p-6">
          ...
          <p className="text-white/90 text-sm line-clamp-2">{boat.shortDescription}</p>
        </div>
      </div>
      ...
      <div className="p-6">
        <div className="grid grid-cols-2 gap-4 mb-4">
          <div className="text-center p-3 bg-gray-50 rounded-lg">
            ...
            <div className="text-sm font-semibold text-gray-900">{boat.capacity}</div>
            <div className="text-xs text-gray-600">άτομα</div>
          </div>
          <div className="text-center p-3 bg-gray-50 rounded-lg">
            <div className="text-2xl mb-1">⚙️</div>
            <div className="text-sm font-semibold text-gray-900">{boat.engine}</div>
