          ...
          <div className='grid md:grid-cols-2 lg:grid-cols-4 gap-8'>
            ...
            <div className='lg:col-span-2'>
              ...
              <p className='text-gray-300 mb-4 max-w-md'>
                Η καλύτερη επιλογή για ενοικίαση RIB στην Αθήνα. Ασφαλείς και
                άνετες περιηγήσεις στον Σαρωνικό με επαγγελματική εξυπηρέτηση.
              </p>

              {/* Address */}
              <div className='text-gray-300'>
                <h4 className='font-semibold text-white mb-2'>Διεύθυνση:</h4>
                <p>Λαγονήσι, Αττική</p>
                <p>Μαρίνα Λαγονησίου</p>
              </div>
            </div>
            ...
            <div>
              ...
              <div className='space-y-3 text-gray-300'>
                ...
                <div className='flex items-center space-x-2'>
                  <span>🕒</span>
                  <span>Δευτέρα - Κυριακή: 08:00 - 20:00</span>
                </div>
              </div>
            </div>
          ...
          <div className='border-t border-gray-700 mt-8 pt-8'>
            <div className='flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0'>
              ...
              <div className='text-gray-400 text-center md:text-right'>
                <p>
                  &copy; {currentYear} RentRibAthens. Όλα τα δικαιώματα
                  διατηρούνται.
                </p>
