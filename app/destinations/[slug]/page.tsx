...
export default async function DestinationPage({ params }: DestinationPageProps) {
  ...
  const otherDestinations = getAllDestinations().filter(d => d.id !== destination.id).slice(0, 3);
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-8">
                <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4">
                  ...
                  <div className="text-lg font-semibold">{destination.distance}</div>
                </div>
                <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4">
                ...
                <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4">
                  <div className="text-sm opacity-80 mb-1">Καλύτερος χρόνος</div>
                  <div className="text-lg font-semibold">{destination.bestTime}</div>
                </div>
                <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4">
                  <div className="text-sm opacity-80 mb-1">Αγγλικά</div>
                  <div className="text-lg font-semibold">{destination.nameEn}</div>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="container-custom">
          <div className="grid lg:grid-cols-3 gap-12">
            ...
            <div className="lg:col-span-2">
              <div className="mb-8">
                <h2 className="text-3xl font-bold text-gray-900 mb-4">Σχετικά με τον Προορισμό</h2>
              ...
              {/* Highlights */}
              <div className="mb-8">
                <h2 className="text-2xl font-bold text-gray-900 mb-4">Αξιοθέατα & Χαρακτηριστικά</h2>
              ...
              {/* Tips */}
              <div className="mb-8">
                <h2 className="text-2xl font-bold text-gray-900 mb-4">Συμβουλές & Πληροφορίες</h2>
                <div className="space-y-3">
                  {destination.tips.map((tip, index) => (
                    <div key={index} className="flex items-start bg-blue-50 border border-blue-100 rounded-lg p-4">
            ...
            <div className="lg:col-span-1">
              ...
              <div className="bg-primary text-white rounded-xl p-6 mb-6 sticky top-24">
                <h3 className="text-2xl font-bold mb-4">Κλείστε την Εκδρομή σας</h3>
              ...
              <div className="bg-gray-50 rounded-xl p-6 mb-6">
                <h3 className="text-xl font-bold text-gray-900 mb-4">Πληροφορίες Εκδρομής</h3>
                <div className="space-y-4">
                  ...
                  <div>
                    <div className="text-sm text-gray-600 mb-1">Διάρκεια Ταξιδιού</div>
                    <div className="font-semibold text-gray-900">{destination.duration}</div>
                  </div>
                  <div>
                    <div className="text-sm text-gray-600 mb-1">Καλύτερος Χρόνος</div>
              ...
              <div className="bg-accent/10 border border-accent/20 rounded-xl p-6">
                <h3 className="text-xl font-bold text-gray-900 mb-4">Διαθέσιμες Υπηρεσίες</h3>
                <div className="space-y-3">
                  <div className="flex items-center">
                    <span className="text-accent mr-2">🚤</span>
                    <span className="text-gray-700">Κρουαζιέρα με κάπετανο</span>
                  </div>
                  <div className="flex items-center">
                  ...
                  <div className="flex items-center">
                    <span className="text-accent mr-2">⭐</span>
                    <span className="text-gray-700">Αποκλειστικές VIP υπηρεσίες</span>
                  </div>
                </div>
              </div>
            </div>
              ...
              <Link key={otherDest.id} href={`/destinations/${otherDest.slug}`}>
                <div className="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-all duration-300 cursor-pointer group">
                  ...
                  <div className="p-6">
                    ...
                    <p className="text-gray-600 mb-4 text-sm">{otherDest.shortDescription}</p>
