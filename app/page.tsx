      ...
      <section className='section-padding bg-white'>
        <div className='container-custom'>
          <div className='text-center mb-16'>
            ...
            <p className='text-lg text-gray-600 max-w-2xl mx-auto'>
              Πλήρης εξοπλισμός και εξειδικευμένη εξυπηρέτηση για την καλύτερη
              εμπειρία
            </p>
          </div>
                        ...
                        <div className='mb-4 bg-accent/10 border border-accent/20 rounded-lg p-3'>
                          <div className='flex items-start'>
                            ...
                            <p className='text-sm text-gray-700'>
                              ...
                              Προσφέρουμε αποκλειστικές VIP{' '}
                              {service.id === 'cruises'
                                ? 'κρουαζιέρες'
                                : 'μεταφορές'}{' '}
                              σύμφωνα με τις ανάγκες σας. Επικοινωνήστε μαζί μας
                              για προσαρμοσμένη εξυπηρέτηση.
                            </p>
                          </div>
                        </div>
                      )}
          ...
          <div className='grid md:grid-cols-3 gap-8'>
            ...
            <div className='bg-gray-50 rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow duration-300'>
              ...
              <p className='text-gray-700 mb-6 leading-relaxed'>
                &ldquo;Εξαιρετική εμπειρία! Το σκάφος ήταν άριστα συντηρημένο
                και ο κάπετανος πολύ επαγγελματίας. Περνούσαμε υπέροχα στο
                Σαρωνικό. Σίγουρα θα το ξανακάνουμε!&rdquo;
              </p>
              <div className='flex items-center'>
            ...
            <div className='bg-gray-50 rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow duration-300'>
              ...
              <p className='text-gray-700 mb-6 leading-relaxed'>
                &ldquo;Amazing experience! We rented the Olympic 490 for a
                family day trip around the Saronic Gulf. The boat was clean,
                safe, and perfect for our group. The captain was professional
                and showed us beautiful spots. Highly recommend!&rdquo;
              </p>
              <div className='flex items-center'>
            ...
            <div className='bg-gray-50 rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow duration-300'>
              ...
              <p className='text-gray-700 mb-6 leading-relaxed'>
                &ldquo;Εντυπωσιακή ημέρα στο Ribco 27! Γρήγορο, άνετο και με
                πλήρη εξοπλισμό ασφαλείας. Οι φίλοι μου ήταν ενθουσιασμένοι. Θα
                επιστρέψουμε σίγουρα!&rdquo;
              </p>
              <div className='flex items-center'>
                <div className='w-12 h-12 bg-primary rounded-full flex items-center justify-center text-white font-bold text-lg mr-4'>
                  ΝΔ
          ...
          <div className='container-custom'>
            <div className='text-center'>
              ...
              <div className='flex flex-col sm:flex-row gap-4 justify-center'>
                <a href='tel:+302101234567' className='btn-secondary'>
                  Επικοινωνία
                </a>
                <Link
                  href='/contact'
