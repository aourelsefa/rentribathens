  ...
  const additionalServices = [
    {
      ...
      description:
        'Ζωσωστικά, αγκυροβόλιο, πυροσβεστήρες και όλος ο απαραίτητος εξοπλισμός ασφαλείας',
      icon: <span className='text-2xl'>⚓</span>,
    },
    {
      title: 'Επαγγελματίες Κάπετανοι',
      description:
        'Εμπειρογνώμονες κάπετανοι με πιστοποιήσεις για ασφαλή και ευχάριστη διαδρομή',
      icon: <span className='text-2xl'>👨‍✈️</span>,
    },
    {
      title: 'Ευέλικτη Κράτηση',
      description:
        'Κράτηση με λίγες ώρες νωρίτερα, ακύρωση εύκολη και ασφαλή πληρωμή',
      icon: <span className='text-2xl'>📅</span>,
    },
    {
    ...
    },
    {
      title: 'Ασφάλιση',
      description:
        'Πλήρης ασφάλιση επιβατών και σκάφους για την απόλυτη ασφάλεια',
      icon: <span className='text-2xl'>🛡️</span>,
    },
    {
      title: 'Βοηθητικά Συσκευές',
      description:
        'GPS, ραδιόφωνο, σκάφος διάσωσης και όλες οι σύγχρονες συσκευές',
      icon: <span className='text-2xl'>📡</span>,
    },
  ];
        ...
        <div className='container-custom'>
          <div className='text-center mb-12'>
            ...
            <p className='text-lg text-gray-600 max-w-2xl mx-auto'>
              Ανακαλύψτε τις κύριες υπηρεσίες που προσφέρουμε για την καλύτερη
              εμπειρία
            </p>
          </div>
