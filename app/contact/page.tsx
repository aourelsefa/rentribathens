...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      'Επικοινωνήστε μαζί μας για κράτηση RIB σκαφών. Άμεση εξυπηρέτηση.',
  },
};
          ...
          <div className='mb-16'>
            ...
            <div className='grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4'>
              ...
              >
                <div className='w-12 h-12 mx-auto mb-3 flex items-center justify-center'>
                  <svg
                    className='w-8 h-8 text-green-500 group-hover:scale-110 transition-transform duration-300'
                    fill='currentColor'
                    viewBox='0 0 24 24'
                  >
              ...
              >
                <div className='w-12 h-12 mx-auto mb-3 flex items-center justify-center'>
                  <svg
                    className='w-8 h-8 text-pink-500 group-hover:scale-110 transition-transform duration-300'
                    fill='currentColor'
                    viewBox='0 0 24 24'
                  >
              ...
              >
                <div className='w-12 h-12 mx-auto mb-3 flex items-center justify-center'>
                  <svg
                    className='w-8 h-8 text-gray-600 group-hover:scale-110 transition-transform duration-300'
                    fill='currentColor'
                    viewBox='0 0 24 24'
                  >
      ...
      <section className='section-padding'>
        <div className='container-custom'>
          <div className='text-center mb-12'>
            ...
            <p className='text-lg text-gray-600 max-w-2xl mx-auto'>
              Βρίσκουμαστε στη Μαρίνα Λαγονησίου, με εύκολη πρόσβαση από την
              Αθήνα
            </p>
          </div>
                ...
                <div>
                  ...
                  <ul className='space-y-2 text-gray-600'>
                    <li className='flex items-start'>
                      ...
                      <div>
                        <strong>Με αυτοκίνητο:</strong>
                        <br />
                        Από Αθήνα: Εθνική Οδός Αθηνών-Κορίνθου, έξοδος Λαγονήσι
                        → Μαρίνα
                      </div>
                    </li>
                    <li className='flex items-start'>
                    ...
                    <li className='flex items-start'>
                      ...
                      <div>
                        <strong>Χρόνος διαδρομής:</strong>
                        <br />
            ...
            <div className='space-y-6'>
              <div className='bg-white rounded-xl shadow-lg p-6'>
                ...
                <p className='text-gray-600'>
                  Προτείνουμε να κάνετε κράτηση τουλάχιστον 24 ώρες νωρίτερα,
                  αλλά μπορούμε να εξυπηρετήσουμε και last-minute κρατήσεις
              ...
              <div className='bg-white rounded-xl shadow-lg p-6'>
                ...
                <p className='text-gray-600'>
                  Η τιμή συμπεριλαμβάνει το σκάφος, τον κάπετανο, όλο τον
                  εξοπλισμό ασφαλείας, καύσιμα και ασφάλιση. Δεν
                  συμπεριλαμβάνονται φαγητά και ποτά.
                </p>
              </div>
              ...
              <div className='bg-white rounded-xl shadow-lg p-6'>
                ...
                <p className='text-gray-600'>
                  Φέρτε μαζί σας μαγιό, πετσέτα, αντιηλιακό, καπέλο και
                  φωτογραφική μηχανή. Παρέχουμε νερό και απαραίτητα ασφάλιστρα.
                </p>
              </div>
              ...
              <div className='bg-white rounded-xl shadow-lg p-6'>
                ...
                <p className='text-gray-600'>
                  Ναι, μπορείτε να ακυρώσετε μέχρι 24 ώρες πριν την εκδρομή
                  χωρίς χρέωση. Για ακυρώσεις την τελευταία στιγμή, μπορεί να
                  υπάρχει μικρή χρέωση.
                </p>
              </div>
            </div>
          </div>
