                ...
                <div>
                  ...
                  <div className="grid grid-cols-3 gap-4">
                    <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4">
                      <div className="text-3xl font-bold mb-1">{boat.capacity}</div>
                      <div className="text-sm opacity-80">Άτομα</div>
                    </div>
                    <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4">
                      <div className="text-3xl font-bold mb-1">{boat.engine}</div>
                      <div className="text-sm opacity-80">Κινητήρας</div>
                    </div>
                    <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4">
                      <div className="text-3xl font-bold mb-1">€{boat.pricePerDay}</div>
      ...
      <section className="section-padding">
        <div className="container-custom">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="mb-16">
              <h2 className="text-3xl font-bold text-gray-900 mb-6">Φωτογραφίες</h2>
            ...
            <div className="grid lg:grid-cols-3 gap-12">
              ...
              <div className="lg:col-span-2">
                {/* Description */}
                <div className="mb-12">
                  <h2 className="text-3xl font-bold text-gray-900 mb-6">Περιγραφή</h2>
                ...
                <div className="mb-12">
                  <h2 className="text-3xl font-bold text-gray-900 mb-6">Τεχνικά Χαρακτηριστικά</h2>
                  <div className="grid md:grid-cols-2 gap-4">
                    {boat.manufacturer && (
                      <div className="bg-gray-50 rounded-xl p-6 border border-gray-200">
                        <div className="text-sm text-gray-500 mb-2">Κατασκευαστής</div>
                        <div className="text-xl font-bold text-gray-900">{boat.manufacturer}</div>
                      </div>
                    )}
                    {boat.model && (
                      <div className="bg-gray-50 rounded-xl p-6 border border-gray-200">
                        <div className="text-sm text-gray-500 mb-2">Μοντέλο</div>
                        <div className="text-xl font-bold text-gray-900">{boat.model}</div>
                      </div>
                    )}
                    {boat.yearBuilt && (
                      <div className="bg-gray-50 rounded-xl p-6 border border-gray-200">
                        <div className="text-sm text-gray-500 mb-2">Έτος Κατασκευής</div>
                        <div className="text-xl font-bold text-gray-900">{boat.yearBuilt}</div>
                      </div>
                    )}
                    {boat.yearRefurbished && (
                      <div className="bg-gray-50 rounded-xl p-6 border border-gray-200">
                        <div className="text-sm text-gray-500 mb-2">Έτος Ανακατασκευής</div>
                        <div className="text-xl font-bold text-gray-900">{boat.yearRefurbished}</div>
                      </div>
                    )}
                    {boat.boatType && (
                      <div className="bg-gray-50 rounded-xl p-6 border border-gray-200">
                        <div className="text-sm text-gray-500 mb-2">Τύπος Σκάφους</div>
                        <div className="text-xl font-bold text-gray-900">{boat.boatType}</div>
                      </div>
                    )}
                    {boat.length && (
                      <div className="bg-gray-50 rounded-xl p-6 border border-gray-200">
                        <div className="text-sm text-gray-500 mb-2">Μήκος</div>
                        <div className="text-xl font-bold text-gray-900">{boat.length}</div>
                      </div>
                    )}
                    {boat.fuelCapacity && (
                      <div className="bg-gray-50 rounded-xl p-6 border border-gray-200">
                        <div className="text-sm text-gray-500 mb-2">Χωρητικότητα Καυσίμου</div>
                        <div className="text-xl font-bold text-gray-900">{boat.fuelCapacity}</div>
                      </div>
                    )}
                    {boat.maxSpeed && (
                      <div className="bg-gray-50 rounded-xl p-6 border border-gray-200">
                        <div className="text-sm text-gray-500 mb-2">Μέγιστη Ταχύτητα</div>
                        <div className="text-xl font-bold text-gray-900">{boat.maxSpeed}</div>
                      </div>
                    )}
                    {boat.fuelType && (
                      <div className="bg-gray-50 rounded-xl p-6 border border-gray-200">
                        <div className="text-sm text-gray-500 mb-2">Τύπος Καυσίμου</div>
                        <div className="text-xl font-bold text-gray-900">{boat.fuelType}</div>
                      </div>
                    )}
                    {boat.fuelConsumption && (
                      <div className="bg-gray-50 rounded-xl p-6 border border-gray-200">
                        <div className="text-sm text-gray-500 mb-2">Κατανάλωση</div>
                        <div className="text-xl font-bold text-gray-900">{boat.fuelConsumption}</div>
                      </div>
                    )}
                    {boat.waterCapacity && (
                      <div className="bg-gray-50 rounded-xl p-6 border border-gray-200">
                        <div className="text-sm text-gray-500 mb-2">Χωρητικότητα Νερού</div>
                        <div className="text-xl font-bold text-gray-900">{boat.waterCapacity}</div>
                      </div>
                    )}
                  </div>
                </div>
                ...
                {/* Capacity & Facilities */}
                <div className="mb-12">
                  <h2 className="text-3xl font-bold text-gray-900 mb-6">Χωρητικότητα & Εγκαταστάσεις</h2>
                  <div className="bg-gradient-to-br from-primary/5 to-accent/5 rounded-2xl p-8 border border-primary/10">
                    <div className="grid md:grid-cols-3 gap-6">
                      <div className="text-center">
                        <div className="text-4xl mb-2">👥</div>
                        <div className="text-2xl font-bold text-gray-900 mb-1">{boat.cruiseGuests || boat.capacity}</div>
                        <div className="text-sm text-gray-600">Επισκέπτες</div>
                      </div>
                      {boat.sleepGuests !== undefined && (
                        <div className="text-center">
                          <div className="text-4xl mb-2">🛏️</div>
                          <div className="text-2xl font-bold text-gray-900 mb-1">{boat.sleepGuests}</div>
                          <div className="text-sm text-gray-600">Επισκέπτες Ύπνου</div>
                        </div>
                      )}
                      {boat.bathrooms !== undefined && (
                        <div className="text-center">
                          <div className="text-4xl mb-2">🚿</div>
                          <div className="text-2xl font-bold text-gray-900 mb-1">{boat.bathrooms}</div>
                      ...
                      {boat.cabins !== undefined && (
                        <div className="text-center">
                          <div className="text-4xl mb-2">🛏️</div>
                          <div className="text-2xl font-bold text-gray-900 mb-1">{boat.cabins || 0}</div>
                      ...
                      {boat.kitchens !== undefined && (
                        <div className="text-center">
                          <div className="text-4xl mb-2">🍳</div>
                          <div className="text-2xl font-bold text-gray-900 mb-1">{boat.kitchens}</div>
                ...
                {/* Rules - Modern Style */}
                <div className="mb-12">
                  <h2 className="text-3xl font-bold text-gray-900 mb-6">Κανονισμοί & Κανόνες</h2>
                  <div className="grid md:grid-cols-2 gap-4">
              ...
              <div className="lg:col-span-1">
                ...
                <div className="sticky top-24 mb-6">
                  <div className="bg-primary text-white rounded-2xl p-8 shadow-xl">
                    <div className="text-center mb-6">
                      <div className="text-5xl font-bold mb-2">€{boat.pricePerDay}</div>
                      <div className="text-lg opacity-90">ανά ημέρα</div>
                      <div className="text-sm opacity-75 mt-2">*Δεν περιλαμβάνει κάπετανο</div>
                      {boat.priceNotes && (
                        <div className="text-sm opacity-75 mt-1">{boat.priceNotes}</div>
                      )}
                    </div>
                    ...
                    <div className="pt-6 border-t border-white/20">
                      <div className="text-sm space-y-2">
                        <div className="flex items-center justify-between">
                          ...
                          <span className="font-semibold">{boat.capacity} άτομα</span>
                        </div>
                        <div className="flex items-center justify-between">
                ...
                <div className="bg-white border-2 border-gray-200 rounded-xl p-6 mb-6">
                  <h3 className="text-xl font-bold text-gray-900 mb-4">Επιλογές Ενοικίασης</h3>
                  <div className="space-y-4">
                    <div className="flex items-start">
                      ...
                      <div>
                        <div className="font-semibold text-gray-900 mb-1">Με Κάπετανο</div>
                        <div className="text-sm text-gray-600">Επαγγελματικός κάπετανος με πιστοποίηση</div>
                      </div>
                    </div>
                    <div className="flex items-start">
                      ...
                      <div>
                        <div className="font-semibold text-gray-900 mb-1">Χωρίς Κάπετανο</div>
                        <div className="text-sm text-gray-600">Απαιτείται άδεια οδήγησης σκάφους</div>
                      </div>
                    </div>
                  </div>
                  <div className="mt-4 bg-blue-50 border border-blue-200 rounded-lg p-3">
                    <div className="flex items-start">
                      ...
                      <p className="text-xs text-blue-800">
                        Για ενοικίαση χωρίς κάπετανο, απαιτείται έγκυρη άδεια οδήγησης σκάφους και εμπειρία στη ναυσιπλοΐα.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-gray-50 rounded-xl p-6">
                  <h3 className="text-lg font-bold text-gray-900 mb-4">Πληροφορίες</h3>
                  <div className="space-y-3 text-sm">
                    <div className="flex items-center justify-between">
                      <span className="text-gray-600">Φωτογραφίες:</span>
                      <span className="font-semibold text-gray-900">{boat.images.length}</span>
                    </div>
                    <div className="flex items-center justify-between">
                      <span className="text-gray-600">Κατάσταση:</span>
                      <span className="font-semibold text-green-600">Διαθέσιμο</span>
                    </div>
                    {boat.yearRefurbished && (
                      <div className="flex items-center justify-between">
                        <span className="text-gray-600">Ανακατασκευή:</span>
                        <span className="font-semibold text-gray-900">{boat.yearRefurbished}</span>
                      </div>
                    )}
                  </div>
                </div>
